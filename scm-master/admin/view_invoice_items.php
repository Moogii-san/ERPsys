...
<html>
<head>
	<title> Нэхэмжлэлийн дэлгэрэнгүй </title>
...
<body>
	...
	<div id="divToPrint" style="clear:both;" >
		...
		<br/><br/><br/><br/><br/><br/>
			...
			<p id="footer" style="clear:both;display:none;padding-bottom:20px;text-align:center;">Баяралаа!</p>
		</div>
