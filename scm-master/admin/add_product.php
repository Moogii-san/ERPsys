		...
		if($_SESSION['admin_login'] == true) {
			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				...
				if($name != null && $price != null && $unit != null && $category != null && $rdbStock == 1) {
					...
					$requireErr = "* Тайлбараас бусад бүх талбарууд хүчинтэй байх ёстой";
				}
			}
		}
		else {
...
<body>
	...
	<section>
		...
		<ul class="form-list">
		<li>
			<div class="label-block"> <label for="product:name">Бүтээгдэхүүн нэр</label> </div>
		...
		<li>
			<div class="label-block"> <label for="product:description">Борлуулагч</label> </div>
