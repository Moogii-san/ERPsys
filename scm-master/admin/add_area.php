			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				...
				if($areaName != null) {
					...
					if(mysqli_query($con,$query_addArea)) {
						echo "<script> alert(\"Хамрах хүрээ амжилттай нэмэгдлээ.\"); </script>";
						header('Refresh:0');
					}
					else {
...
<body>
	...
	<section>
		...
		<ul class="form-list">
		<li>
			<div class="label-block"> <label for="areaName">Хамрах хүрээ</label> </div>
		...
		<li>
			<div class="label-block"> <label for="areaCode">Код</label> </div>
