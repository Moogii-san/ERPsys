...
<body>
	...
	<section>
		...
		<ul class="form-list">
		<li>
			<div class="label-block"> <label for="categoryName">Төрлийн нэр</label> </div>
			<div class="input-box"> <input type="text" id="categoryName" name="txtCategoryName" placeholder="Цэс" value="<?php echo $row_selectCategoryDetails['cat_name']; ?>" required /> </div> <span class="error_message"><?php echo $categoryNameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="categoryDetails">Тайлбар</label> </div>
			<div class="input-box"><textarea id="categoryDetails" name="txtCategoryDetails" placeholder="Тайлбар"><?php echo $row_selectCategoryDetails['cat_details']; ?></textarea> </div>
		</li>
		<li>
