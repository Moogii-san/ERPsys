		...
		if($_SESSION['admin_login'] == true) {
			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				...
				if($username != null && $password != null && $areacode != null && $phone != null) {
					...
					$requireErr = "* Хэрэглэгчийн нэр, нууц үг, бүсийн код, цахим шуудан заавал байх ёстой";
				}
			}
		}
		else {
...
<body>
	...
	<section>
		...
		<ul class="form-list">
		<li>
			<div class="label-block"> <label for="retailer:username">Нэр</label> </div>
		...
		<li>
			<div class="label-block"> <label for="retailer:password">Нууц үг</label> </div>
		...
		<li>
			<div class="label-block"> <label for="retailer:areaCode">Код</label> </div>
			<div class="input-box">
		...
		<li>
			<div class="label-block"> <label for="retailer:phone">Утас</label> </div>
