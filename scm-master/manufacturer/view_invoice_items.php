...
<body>
	...
	<div id="divToPrint" style="clear:both;" >
		<h1 style="text-align:center;">нэхэмжлэл устгах</h1>
		<table class="table_infoFormat">
		<tr>
			<td><b> Нэхэмжлэл дагаар: </b></td>
			<td> <?php echo $rowSelectInvoice['invoice_id']; ?> </td>
		</tr>
		<tr>
			<td><b> Захиалгын дугаар: </b></td>
		...
		<table class="table_invoiceFormat" style="margin-top:50px;">
			<tr>
				<th style="padding-right:25px;"> Sr.Дугаар. </th>
				<th style="padding-right:150px;"> Бүтээгдэхүүн </th>
				<th style="padding-right:30px;"> Тус бүрийн үнэ </th>
				<th style="padding-right:30px;"> Тоо хэмжээ </th>
				<th> Үнэ </th>
			</tr>
			...
			<tr style="height:40px;vertical-align:bottom;">
				<td colspan="4" style="text-align:right;"><b>Нийт үнэ: </b></td>
				<td>
				<?php
		...
		<b>Сэтгэгдэл:</b> <br/> <?php echo $rowSelectInvoice['comments']; ?>
		<br/><br/><br/><br/><br/><br/>
			<p id="signature" style="float:right;display:none;">(Authorized Signatory)</p>
			<p id="footer" style="clear:both;display:none;padding-bottom:20px;text-align:center;">Баярлалаа!</p>
		</div>
		<input type="button" value="Нэхэмжлэл хэвлэх" class="submit_button" onclick="PrintDiv();" />
		</form>
	</section>
	<?php
