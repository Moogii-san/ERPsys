		...
		if($_SESSION['manufacturer_login'] == true) {
			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				if(isset($_POST['chkId'])) {
					...
					if(!$result) {
						echo "<script> alert(\"Бүтээгдэхүүнтэй цэсийг устгаж болохгүй\"); </script>";
						header('Refresh:0');
					}
					else {
...
<body>
	...
	<section>
		...
		<a href="add_category.php"><input type="button" value="Нэмэх" class="submit_button"/></a>
		</form>
	</section>
	<?php
