...
<body>
	...
	?>
	<section>
		<h1>Нэхэмжлэлийн хураангуй</h1>
		<table class="table_infoFormat">
		<tr>
			<td> Нэхэмжлэлийн дугаар: </td>
			<td> <?php echo $row_selectInvoiceId['AUTO_INCREMENT']; ?> </td>
		</tr>
		<tr>
			<td> Нэхэмжлэлийн огноо: </td>
		...
		<table class="table_invoiceFormat">
			...
			Ship via: &nbsp;&nbsp;&nbsp;&nbsp;<select name="distributor">
				<option value="" disabled selected>--- Борлуулалгч сонгох ---</option>
			...
			<br/>
			<input type="submit" value="Нэхэмжлэх" class="submit_button" />
