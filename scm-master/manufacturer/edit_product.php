...
<body>
	...
	<section>
		...
		<li>
		<div class="label-block"> <label for="product:unit">Нэгжийн төрөл</label> </div>
		<div class="input-box">
		...
		<li>
		<div class="label-block"> <label for="product:category">Төрөл</label> </div>
		<div class="input-box">
		...
		<li>
			<div class="label-block"> <label for="product:stock">Нөөц</label> </div>
			<input type="radio" name="rdbStock" value="1">Байгаа
			<input type="radio" name="rdbStock" value="2">Байхгүй
		</li>
		<li>
			<div class="label-block"> <label for="product:description">Тайлбар</label> </div>
			<div class="input-box"> <textarea type="text" id="product:description" name="txtProductDescription" placeholder="Тайлбар"><?php echo $row_selectProductDetails['pro_desc']; ?></textarea> </div>
		</li>
		<li>
